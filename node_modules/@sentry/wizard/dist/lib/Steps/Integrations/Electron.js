...
var MIN_ELECTRON_VERSION = parseInt(MIN_ELECTRON_VERSION_STRING.replace(/\D+/g, ''));
var appPackage = {};
try {
...
var Electron = /** @class */ (function (_super) {
    ...
    Electron.prototype.emit = function (answers) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                Logging_1.nl();
                Logging_1.l('Put these lines in to your main and renderer processes to corretly run Sentry.');
                Logging_1.l('It will catch all possible crashes javascript/node/native:');
                Logging_1.nl();
                Logging_1.green("const { SentryClient } = require('@sentry/electron');");
                Logging_1.nl();
                Logging_1.green("SentryClient.create({");
                Logging_1.green("  dsn: '" + dsn + "'");
                Logging_1.green("});");
                Logging_1.nl();
                Logging_1.l('Also please run following command to upload symbols to Sentry for native crash handling:');
                Logging_1.green("node sentry-symbols.js");
                Logging_1.nl();
                Logging_1.l('See https://docs.sentry.io/clients/javascript/integrations/electron/ for more details');
                Logging_1.nl();
                return [2 /*return*/, {}];
            });
        });
    ...
    Electron.prototype.checkDep = function (packageName, minVersion) {
        // tslint:disable-next-line:radix
        var depVersion = parseInt(_.get(appPackage, "dependencies." + packageName, '0').replace(/\D+/g, ''));
        // tslint:disable-next-line:radix
        var devDepVersion = parseInt(_.get(appPackage, "devDependencies." + packageName, '0').replace(/\D+/g, ''));
